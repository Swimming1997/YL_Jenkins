...
try {
    ...
    Assert-True ($dindMaintenance -match 'builder prune --force --reserved-space' -and $dindMaintenance -match '4294967296' -and $dindMaintenance -match 'DIND_MAINTENANCE_EVIDENCE' -and $dindMaintenance -notmatch '(?i)(?:system|volume)\s+prune') 'DIND helper bounds only its dedicated BuildKit cache and emits structured evidence without global prune.'
